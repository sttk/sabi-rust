...
mod err;
pub use err::{
    add_async_err_handler, add_sync_err_handler, fix_err_handlers, ErrContent, ErrOccasion,
};
...
/// Is the struct that represents an error used commonly in across the Sabi Framework.
///

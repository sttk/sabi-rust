...
impl DataHub {
    ...
    /// Global data sources, if any, are copied into this instance.
...
impl<'a> Runner<'a> {
    ...
    /// [`run_async`][Runner::run_async] and [`run_or_block_async`][Runner::run_or_block_async] are
    /// skipped.
    ///
    /// # Parameters
    ///
    ...
    ///
    /// If the logic function fails, its error is collected and subsequent calls to
    /// [`run_async`][Runner::run_async], [`run_force_async`][Runner::run_force_async], and
    /// [`run_or_block_async`][Runner::run_or_block_async] are skipped.
    ///
    /// # Parameters
    ///
    /// * `logic_fn`: A closure that encapsulates the business logic to be executed.
